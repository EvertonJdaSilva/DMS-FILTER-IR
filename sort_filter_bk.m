function [Plist,Flist,Llist,alfa] = sort_filter_bk(Plist,Flist,Llist,alfa,stop_alfa,tol_stop,tol_feasible,par_ratio,count_poll_1,count_poll)
...
elseif (count_poll_1 > 0.5*count_poll && ~isempty(Ffeasible) && ~isempty(Finfeasible))
